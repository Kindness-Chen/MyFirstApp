...
public class AESCoder {
    ...
    static String TAG_PNC = "YTBASE";

    static {
        IV = CryptoUtil.getConfigKey("AESCODER_IV");
    }
    ...
    public static String encrypt(String data) throws Exception {
        byte[] encryptData = encrypt(data.getBytes(), CryptoUtil.getConfigKey("AESCODER_KEY").getBytes(), DEFAULT_CIPHER_ALGORITHM);
    ...
    public static String decrypt(String data) throws Exception {
        byte[] decryptData = decrypt(Base64Util.decode(data), CryptoUtil.getConfigKey("AESCODER_KEY").getBytes(), DEFAULT_CIPHER_ALGORITHM);
