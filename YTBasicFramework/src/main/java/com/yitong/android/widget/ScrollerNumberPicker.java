...
//		RectF rect = new RectF(0, controlHeight / 2 - unitHeight / 2 + 2,
//				controlWidth, controlHeight / 2 + unitHeight / 2 - 2);
...
//		canvas.drawRect(rect, linePaint);
	...
	private void drawMask(Canvas canvas) {
		...
		LinearGradient lg = new LinearGradient(0, 0, 0, maskHight*1.5f, Color.parseColor("#FFFFFF"),
				Color.parseColor("#00FFFFFF"), TileMode.MIRROR);
		Paint paint = new Paint();
		paint.setShader(lg);
		canvas.drawRect(0, 0, controlWidth, maskHight, paint);

		LinearGradient lg2 = new LinearGradient(0, controlHeight - maskHight*1.5f,
				0, controlHeight, Color.parseColor("#00FFFFFF"),  Color.parseColor("#FFFFFF"), TileMode.MIRROR);
