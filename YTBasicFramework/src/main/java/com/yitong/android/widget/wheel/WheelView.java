...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		LinearGradient gradient = 
				new LinearGradient(0, 0, 0, center-offset, 0xffffffff, 0x00ffffff, Shader.TileMode.MIRROR);
		paint.setShader(gradient);
		canvas.drawRect(0, 0, getWidth(), center - offset, paint);
		gradient = 
				new LinearGradient(0, getHeight(), 0, center + offset, 0xffffffff, 0x00ffffff, Shader.TileMode.MIRROR);
		paint.setShader(gradient);
